...
window.dom = {
  ...
  after: function after(node, node2) {
    console.log("node2".concat(node2));
    node.parentNode.insertBefore(node2, null); // 如果 referenceNode 为 null 则 newNode 将被插入到子节点的末尾。
  },
